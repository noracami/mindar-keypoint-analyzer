...
經研究，MindAR 的 Compiler 本身就是 JavaScript 實作，提供瀏覽器端 API（`mind-ar/src/image-target/compiler.js` 中的 `Compiler` 類別），可以直接在網頁中呼叫，不需要依賴官方線上工具。參考 [mind-ar-js#493](https://github.com/hiukim/mind-ar-js/issues/493#issuecomment-1914911754) 的討論與範例。
